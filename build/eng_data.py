...
c1s1 = {
    ...
    "quiz": [
        ...
        {"id": 7, "type": "choice", "point": "国名与国籍形容词",
         ...
         "options": ["A. Japanese; Japan", "B. Japanese; Japanese", "C. Japan; Japan", "D. Japan; Japanese"],
         "answer": "D",
...
c1s2 = {
    ...
    "quiz": [
        ...
        {"id": 6, "type": "choice", "point": "Whose 与 who’s 辨析（同音陷阱）",
         ...
         "options": ["A. Whose; Tom’s", "B. Who’s; Tom", "C. Who’s; Tom’s", "D. Whose; Tom"],
         "answer": "A",
        ...
        {"id": 10, "type": "choice", "point": "her 与 hers",
         ...
         "options": ["A. her; Hers", "B. her; Her", "C. hers; Hers", "D. hers; Her"],
         "answer": "D",
...
c1s3 = {
    ...
    "quiz": [
        ...
        {"id": 4, "type": "choice", "point": "复数拼写综合（刁钻）",
         ...
         "options": ["A. tomatos, knifes, childs", "B. tomatos, knives, children", "C. tomatoes, knifes, childrens", "D. tomatoes, knives, children"],
         "answer": "D",
...
c1s4 = {
    ...
    "quiz": [
        ...
        {"id": 6, "type": "choice", "point": "主格与宾格",
         ...
         "options": ["A. them; They", "B. they; Them", "C. them; Them", "D. they; They"],
         "answer": "A",
...
c1s5 = {
    ...
    "quiz": [
        ...
        {"id": 14, "type": "choice", "point": "复数形式综合（刁钻）", "stem": "下列复数形式<b>全部正确</b>的一组是（　）",
         "options": ["A. men, women, children", "B. mans, womans, childs", "C. men, womens, childrens", "D. mans, women, children"],
         "answer": "A",
...
c1s6 = {
    ...
    "quiz": [
        ...
        {"id": 6, "type": "choice", "point": "深浅颜色的表达", "stem": "“浅蓝色”的正确说法是（　）",
         "options": ["A. small blue", "B. white blue", "C. thin blue", "D. light blue"],
         "answer": "D",
