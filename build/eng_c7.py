...
s1 = {
    ...
    "quiz": [
        ...
        {"id": 7, "type": "choice", "point": "主将从现",
         ...
         "options": ["A. won’t rain", "B. doesn’t rain", "C. isn’t raining", "D. didn’t rain"],
         "answer": "B",
...
s2 = {
    ...
    "quiz": [
        ...
        {"id": 6, "type": "choice", "point": "不可数名词的量词",
         ...
         "options": ["A. piece", "B. pieces", "C. advices", "D. bags"],
         "answer": "B",
        ...
        {"id": 11, "type": "judge", "point": "news 的可数性",
         "stem": "news 虽然以 s 结尾，但它是不可数名词，配单数动词。",
         "answer": "对",
         "explain": "对。<b>The news is good.</b>（不是 are）。同类“看着像复数其实不是”的还有 maths、physics、politics。反过来 clothes、trousers、glasses 永远是复数。"},
...
s3 = {
    ...
    "quiz": [
        ...
        {"id": 3, "type": "multi", "point": "两类物主代词（想一想·刁钻）",
         "stem": "下列句子<b>正确</b>的有（　）【多选】",
        ...
        {"id": 11, "type": "judge", "point": "his 与 its 的特殊性",
         "stem": "在所有物主代词中，只有 his 和 its 的形容词性形式和名词性形式完全相同。",
         "answer": "对",
         "explain": "对。my→mine、your→yours、her→hers、our→ours、their→theirs 都要变形，唯独 <b>his→his</b>、<b>its→its</b> 不变。所以 This is his book. 和 This book is his. 里的 his 长得一样但词性不同。"},
...
s5 = {
    ...
    "quiz": [
        ...
        {"id": 5, "type": "multi", "point": "too / enough 的位置（想一想·刁钻）",
         "stem": "下列表达<b>正确</b>的有（　）【多选】",
        ...
        {"id": 8, "type": "choice", "point": "too...to 句型",
         ...
         "options": ["A. too, to", "B. so, that", "C. very, that", "D. enough, to"],
         "answer": "B",
...
s6 = {
    ...
    "quiz": [
        ...
        {"id": 6, "type": "choice", "point": "主动变被动",
         ...
         "options": ["A. builds", "B. was built", "C. is built", "D. was build"],
         "answer": "B",
        ...
        {"id": 7, "type": "choice", "point": "同义句改写",
         ...
         "options": ["A. too, that", "B. so, that", "C. very, that", "D. so, to"],
         "answer": "B",
        ...
        {"id": 11, "type": "judge", "point": "提问要删划线部分",
         "stem": "对划线部分提问时，要把划线的那部分内容从句子里删掉，用疑问词代替。",
         "answer": "对",
         "explain": "对。He went to <u>Beijing</u>. → <b>Where</b> did he go? ✓（Beijing 已被 Where 代替）。写成 Where did he go to Beijing? ✗ 就是保留了不该保留的内容。"},
